...
/**
 * Card Component System - Flexible container components
 * 
 * Design Strategy:
 * - Semantic HTML structure with proper heading hierarchy
 * - Consistent spacing and border radius across the app
 * - Dark/light theme support with proper contrast
 * - Responsive padding that scales with screen size
 * - Accessible focus states and proper ARIA structure
 * 
 * Usage: Dashboard metrics, content sections, form containers
 */
